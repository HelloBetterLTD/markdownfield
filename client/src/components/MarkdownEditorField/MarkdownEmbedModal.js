...
class MarkdownEmbedModal extends Component {
...
MarkdownEmbedModal.defaultProps = {
    className: '',
    fileAttributes: {},
};
...
export { MarkdownEmbedModal };

export default connect(mapStateToProps, mapDispatchToProps)(MarkdownEmbedModal);